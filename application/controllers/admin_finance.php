...
class Admin_finance extends CI_Controller {
	...
	function index(){
		...
		$data['page_title'] = "Skywash Laundry | Keuangan";
	...
	function jurnal($error){
		...
		$data['page_title'] = "Skywash Laundry | Jurnal";
	...
	function jurnal_penyesuaian($error){
		...
		$data['page_title'] = "Skywash Laundry | Jurnal Penyesuaian";
	...
	function input($error){
		...
		$data['page_title'] = "Skywash Laundry | Input Pengeluaran";
	...
	function buku($error){
		...
		$data['page_title'] = "Skywash Laundry | Buku Besar";
	...
	function neracaSaldo($error){
		...
		$data['page_title'] = "Skywash Laundry | Neraca Saldo";
	...
	function labarugi($error){
		...
		$data['page_title'] = "Skywash Laundry | Laba / Rugi";
	...
	function neraca($error){
		...
		$data['page_title'] = "Skywash Laundry | Neraca";
