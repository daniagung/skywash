...
class Admin_grafik extends CI_Controller {
	...
	function cuciArea(){
		...
		$data['page_title'] = "Skywash Laundry | Frekuensi Transaksi";
	...
	function krisan($id){
		...
		$data['page_title'] = "Skywash Laundry | Respon Pelanggan";
	...
	function statusTrans(){
		...
		$data['page_title'] = "Skywash Laundry | Status Transaksi";
	...
	function omset(){
		...
		$data['page_title'] = "Skywash Laundry | Laporan";
