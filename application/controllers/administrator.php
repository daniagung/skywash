...
class Administrator extends CI_Controller {
	...
	function outlet($outlet){
		...
		$data['page_title'] = "Skywash Laundry | Administrator";
	...
	function outlet_form($outlet,$status,$error){
		...
		$data['page_title'] = "Skywash Laundry | Administrator - Outlet";
	...
	function layanan_form($outlet,$id,$status,$error){
		$data['page_title']="Skywash Laundry | Administrator - Laundry";
	...
	function promo_form($outlet,$id,$group,$status,$error){
		$data['page_title'] = "Skywash Laundry | Administrator - Promo";
	...
	function view_pegawai_form($outlet,$pegawai_id,$status,$error){
		$data['page_title']="Skywash Laundry | Administrator - Pegawai";
	...
	function aset_form($outlet,$status,$error){
		$data['page_title']="Skywash Laundry | Administrator - Aset";
	...
	function investorList(){
		...
		$data['page_title'] = "Skywash Laundry | Investor";
