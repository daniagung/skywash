...
class Customer extends CI_Controller {
	...
	function member(){
		...
		$data['page_title'] = "Skywash Laundry | Member";
	...
	function printHMember($member){
		$data['page_title'] = "Skywash Laundry | History Transaksi";
	...
	function detailDeposit($dresi){
		...
		$data['page_title'] = "Skywash Laundry | Deposit";
	...
	function printHDepo($member){
		$data['page_title'] = "Skywash Laundry | History Deposit";
	...
	function nonmem(){
		$data['content'] = 'main/customer/member';
		$data['page_title'] = "Skywash Laundry | Non Member";
	...
	function komplain(){
		$data['content'] = 'main/customer/member';
		$data['page_title'] = "Skywash Laundry | Komplain";
